             ...
             <div class="row">
                 <div class="col-xl-10 col-lg-12 m-auto">
                     <section class="row align-items-center mb-50">
                         <div class="col-lg-6">
                             <img alt="" class="border-radius-15 mb-md-3 mb-lg-0 mb-sm-4"
                             ...
                             <div class="pl-25">
                                 ...
                                 <div class="carausel-3-columns-cover position-relative">
                                     ...
                                     <div class="carausel-3-columns" id="carausel-3-columns">
                                         <img alt="" src="{{ asset('assets/images/about-2.png') }}" />
                                         <img alt="" src="{{ asset('assets/images/about-3.png') }}" />
                                         <img alt="" src="{{ asset('assets/images/about-4.png') }}" />
                                         <img alt="" src="{{ asset('assets/images/about-2.png') }}" />
                                     </div>
                                 </div>
                             </div>
                     ...
                     <section class="row align-items-center mb-50">
                         <div class="row mb-50 align-items-center">
                             <div class="col-lg-7 pr-30">
                                 <img alt="" class="mb-md-3 mb-lg-0 mb-sm-4"
                                     src="{{ asset('assets/images/about-5.png') }}" />
                             </div>
                             <div class="col-lg-5">
                             ...
                             <div class="col-lg-8">
                                 <div class="row">
                                     <div class="col-lg-6 col-md-6">
                                         <div class="team-card">
                                             <img alt="" src="{{ asset('assets/images/about-6.png') }}" />
                                             <div class="content text-center">
                                                 ...
                                                 <div class="social-network mt-20">
                                                     <a href="#">
                                                         <img alt=""
                                                             src="{{ asset('assets/images/icon-facebook-brand.svg') }}" />
                                                     </a>
                                                     <a href="#">
                                                         <img alt=""
                                                             src="{{ asset('assets/images/icon-twitter-brand.svg') }}" />
                                                     </a>
                                                     <a href="#">
                                                         <img alt=""
                                                             src="{{ asset('assets/images/icon-instagram-brand.svg') }}" />
                                                     </a>
                                                     <a href="#">
                                                         <img alt=""
                                                             src="{{ asset('assets/images/icon-youtube-brand.svg') }}" />
                                                     </a>
                                                 </div>
                                             </div>
                                         </div>
                                     ...
                                     <div class="col-lg-6 col-md-6">
                                         <div class="team-card">
                                             <img alt="" src="{{ asset('assets/images/about-8.png') }}" />
                                             <div class="content text-center">
                                                 <h4 class="mb-5">
                                                     Dilan Specter
                                                 </h4>
