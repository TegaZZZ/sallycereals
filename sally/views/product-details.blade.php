...
<html class="no-js" lang="en">
 <head>
  ...
  <!-- Favicon -->
  <link href="assets/imgs/theme/favicon.svg" rel="shortcut icon" type="image/x-icon"/>
  <!-- Template CSS -->
  <link href="assets/css/plugins/slider-range.css" rel="stylesheet"/>
  <link href="assets/css/main.css?v=6.0" rel="stylesheet"/>
 </head>
 <body class="single-product">
  <!-- Quick view -->
  <div aria-hidden="true" aria-labelledby="quickViewModalLabel" class="modal fade custom-modal" id="quickViewModal" tabindex="-1">
        ...
        <div class="detail-gallery">
         ...
         <div class="product-image-slider">
          <figure class="border-radius-10">
           <img alt="product image" src="assets/imgs/shop/product-16-2.jpg"/>
          </figure>
          <figure class="border-radius-10">
           <img alt="product image" src="assets/imgs/shop/product-16-1.jpg"/>
          </figure>
          <figure class="border-radius-10">
           <img alt="product image" src="assets/imgs/shop/product-16-3.jpg"/>
          </figure>
          <figure class="border-radius-10">
           <img alt="product image" src="assets/imgs/shop/product-16-4.jpg"/>
          </figure>
          <figure class="border-radius-10">
           <img alt="product image" src="assets/imgs/shop/product-16-5.jpg"/>
          </figure>
          <figure class="border-radius-10">
           <img alt="product image" src="assets/imgs/shop/product-16-6.jpg"/>
          </figure>
          <figure class="border-radius-10">
           <img alt="product image" src="assets/imgs/shop/product-16-7.jpg"/>
          </figure>
         </div>
         <!-- THUMBNAILS -->
         <div class="slider-nav-thumbnails">
          <div>
           <img alt="product image" src="assets/imgs/shop/thumbnail-3.jpg"/>
          </div>
          <div>
           <img alt="product image" src="assets/imgs/shop/thumbnail-4.jpg"/>
          </div>
          <div>
           <img alt="product image" src="assets/imgs/shop/thumbnail-5.jpg"/>
          </div>
          <div>
           <img alt="product image" src="assets/imgs/shop/thumbnail-6.jpg"/>
          </div>
          <div>
           <img alt="product image" src="assets/imgs/shop/thumbnail-7.jpg"/>
          </div>
          <div>
           <img alt="product image" src="assets/imgs/shop/thumbnail-8.jpg"/>
          </div>
          <div>
           <img alt="product image" src="assets/imgs/shop/thumbnail-9.jpg"/>
          </div>
         </div>
        </div>
        <!-- End Gallery -->
       ...
       <div class="col-md-6 col-sm-12 col-xs-12">
        <div class="detail-info pr-30 pl-30">
         ...
         <h3 class="title-detail">
          <a class="text-heading" href="/shop-product-right">
         ...
         <div class="detail-extralink mb-30">
          <div class="detail-qty border radius">
           ...
           <input class="qty-val" min="1" name="quantity" type="text" value="1"/>
           <a class="qty-up" href="#">
     ...
     <div class="row align-items-center">
      ...
      <div class="col-xl-6 col-lg-4">
       <div class="text-center">
        <div class="d-inline-block" id="news-flash">
         <ul>
          <li>
        ...
        <ul>
         ...
         <li>
          ...
          <ul class="language-dropdown">
           <li>
            <a href="#">
             <img alt="" src="assets/imgs/theme/flag-fr.png"/>
             Français
            </a>
           </li>
           <li>
            <a href="#">
             <img alt="" src="assets/imgs/theme/flag-dt.png"/>
             Deutsch
            </a>
           </li>
           <li>
            <a href="#">
             <img alt="" src="assets/imgs/theme/flag-ru.png"/>
             Pусский
            </a>
           </li>
          </ul>
    ...
    <div class="container">
     <div class="header-wrap">
      <div class="logo logo-width-1">
       <a href="/">
        <img alt="logo" src="assets/imgs/theme/logo.svg"/>
       </a>
      </div>
       ...
       <div class="header-action-right">
        <div class="header-action-2">
         ...
         <div class="header-action-icon-2">
          <a href="/shop-compare">
           <img alt="Nest" class="svgInject" src="assets/imgs/theme/icons/icon-compare.svg"/>
         ...
         <div class="header-action-icon-2">
          <a href="/shop-wishlist">
           <img alt="Nest" class="svgInject" src="assets/imgs/theme/icons/icon-heart.svg"/>
           <span class="pro-count blue">
            6
           </span>
          </a>
          ...
          <div class="cart-dropdown-wrap cart-dropdown-hm2">
           ...
           <div class="shopping-cart-footer">
            ...
            <div class="shopping-cart-button">
             <a class="outline" href="/shop-cart">
              View cart
             </a>
         ...
         <div class="header-action-icon-2">
          <a href="/page-account">
           <img alt="Nest" class="svgInject" src="assets/imgs/theme/icons/icon-user.svg"/>
          </a>
          <a href="/page-account">
           <span class="lable ml-0">
            Account
          ...
          <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
           <ul>
            ...
            <li>
             <a href="/page-account">
              <i class="fi fi-rs-location-alt mr-10">
              </i>
              Order Tracking
             </a>
            </li>
            ...
            <li>
             <a href="/page-account">
              <i class="fi fi-rs-settings-sliders mr-10">
              </i>
              Setting
             </a>
            </li>
    ...
    <div class="container">
     <div class="header-wrap header-space-between position-relative">
      ...
      <div class="header-nav d-none d-lg-flex">
        ...
        <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
         <div class="d-flex categori-dropdown-inner">
          <ul>
           <li>
            <a href="/shop-grid-right">
             <img alt="" src="assets/imgs/theme/icons/category-1.svg"/>
             Milks and Dairies
            </a>
           </li>
           <li>
            <a href="/shop-grid-right">
             <img alt="" src="assets/imgs/theme/icons/category-2.svg"/>
             Clothing &amp; beauty
            </a>
           </li>
           <li>
            <a href="/shop-grid-right">
             <img alt="" src="assets/imgs/theme/icons/category-3.svg"/>
             Pet Foods &amp; Toy
            </a>
           </li>
           <li>
            <a href="/shop-grid-right">
             <img alt="" src="assets/imgs/theme/icons/category-4.svg"/>
             Baking material
            </a>
           </li>
           <li>
            <a href="/shop-grid-right">
             <img alt="" src="assets/imgs/theme/icons/category-5.svg"/>
             Fresh Fruit
            </a>
           </li>
          </ul>
          <ul class="end">
           <li>
            <a href="/shop-grid-right">
             <img alt="" src="assets/imgs/theme/icons/category-6.svg"/>
             Wines &amp; Drinks
            </a>
           </li>
           <li>
            <a href="/shop-grid-right">
             <img alt="" src="assets/imgs/theme/icons/category-7.svg"/>
             Fresh Seafood
            </a>
           </li>
           <li>
            <a href="/shop-grid-right">
             <img alt="" src="assets/imgs/theme/icons/category-8.svg"/>
             Fast food
            </a>
           </li>
           <li>
            <a href="/shop-grid-right">
             <img alt="" src="assets/imgs/theme/icons/category-9.svg"/>
             Vegetables
            </a>
           </li>
           <li>
            <a href="/shop-grid-right">
             <img alt="" src="assets/imgs/theme/icons/category-10.svg"/>
             Bread and Juice
            </a>
           </li>
          </ul>
         ...
         <div class="more_slide_open" style="display: none">
          <div class="d-flex categori-dropdown-inner">
           <ul>
            <li>
             <a href="/shop-grid-right">
              <img alt="" src="assets/imgs/theme/icons/icon-1.svg"/>
              Milks and Dairies
             </a>
            </li>
            <li>
             <a href="/shop-grid-right">
              <img alt="" src="assets/imgs/theme/icons/icon-2.svg"/>
              Clothing &amp; beauty
             </a>
            </li>
           </ul>
           <ul class="end">
            <li>
             <a href="/shop-grid-right">
              <img alt="" src="assets/imgs/theme/icons/icon-3.svg"/>
              Wines &amp; Drinks
             </a>
            </li>
            <li>
             <a href="/shop-grid-right">
              <img alt="" src="assets/imgs/theme/icons/icon-4.svg"/>
              Fresh Seafood
             </a>
            </li>
           </ul>
       ...
       <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
        <nav>
         <ul>
          <li class="hot-deals">
           <img alt="hot deals" src="assets/imgs/theme/icons/icon-hot.svg"/>
           <a href="/shop-grid-right">
            Deals
           </a>
          </li>
           ...
           <ul class="sub-menu">
            ...
            <li>
             ...
             <ul class="level-menu">
              ...
              <li>
               <a href="/shop-product-left">
                Product – Left Sidebar
               </a>
              </li>
              <li>
               <a href="/shop-product-full">
                Product – No sidebar
               </a>
              </li>
              <li>
               <a href="/shop-product-vendor">
            ...
            <li>
             ...
             <ul class="level-menu">
              <li>
               <a href="/shop-invoice-1">
                Shop Invoice 1
               </a>
              </li>
              <li>
               <a href="/shop-invoice-2">
                Shop Invoice 2
               </a>
              </li>
              <li>
               <a href="/shop-invoice-3">
                Shop Invoice 3
               </a>
              </li>
              <li>
               <a href="/shop-invoice-4">
                Shop Invoice 4
               </a>
              </li>
              <li>
               <a href="/shop-invoice-5">
                Shop Invoice 5
               </a>
              </li>
              <li>
               <a href="/shop-invoice-6">
                Shop Invoice 6
               </a>
              </li>
             </ul>
           ...
           <ul class="mega-menu">
            ...
            <li class="sub-mega-menu sub-mega-menu-width-34">
             <div class="menu-banner-wrap">
              <a href="/shop-product-right">
               <img alt="Nest" src="assets/imgs/banner/banner-menu.png"/>
              </a>
          ...
          <li>
           ...
           <ul class="sub-menu">
            ...
            <li>
             <a href="/blog-category-list">
              Blog Category List
             </a>
            </li>
            <li>
             <a href="/blog-category-big">
              Blog Category Big
             </a>
            </li>
            <li>
             <a href="/blog-category-fullwidth">
              Blog Category Wide
             </a>
            </li>
            <li>
      ...
      <div class="hotline d-none d-lg-flex">
       <img alt="hotline" src="assets/imgs/theme/icons/icon-headphone.svg"/>
       <p>
        1900 - 888
        <span>
         24/7 Support Center
           ...
           <div class="detail-info pr-30 pl-30">
            ...
            <div class="detail-extralink mb-50">
             ...
             <div class="product-extra-link2">
              ...
              <a aria-label="Add To Wishlist" class="action-btn hover-up" href="/shop-wishlist">
               <i class="fi-rs-heart">
               </i>
              </a>
              <a aria-label="Compare" class="action-btn hover-up" href="/shop-compare">
               <i class="fi-rs-shuffle">
               </i>
              </a>
             </div>
            </div>
         ...
         <div class="product-info">
          <div class="tab-style3">
           <ul class="nav nav-tabs text-uppercase">
            <li class="nav-item">
             <a class="nav-link active" data-bs-toggle="tab" href="#Description" id="Description-tab">
              Description
             </a>
            </li>
            <li class="nav-item">
             <a class="nav-link" data-bs-toggle="tab" href="#Additional-info" id="Additional-info-tab">
              Additional info
             </a>
            </li>
            <li class="nav-item">
             <a class="nav-link" data-bs-toggle="tab" href="#Vendor-info" id="Vendor-info-tab">
              Vendor
             </a>
            </li>
            <li class="nav-item">
             <a class="nav-link" data-bs-toggle="tab" href="#Reviews" id="Reviews-tab">
              Reviews (3)
             </a>
            </li>
           </ul>
           <div class="tab-content shop_info_tab entry-main-content">
            ...
            <div class="tab-pane fade" id="Vendor-info">
             <div class="vendor-logo d-flex mb-30">
              <img alt="" src="assets/imgs/vendor/vendor-18.svg"/>
             ...
             <ul class="contact-infor mb-50">
              <li>
               <img alt="" src="assets/imgs/theme/icons/icon-location.svg"/>
               <strong>
                Address:
               </strong>
               <span>
              ...
              <li>
               <img alt="" src="assets/imgs/theme/icons/icon-contact.svg"/>
               <strong>
                Contact Seller:
               </strong>
               <span>
              ...
              <div class="row">
               <div class="col-lg-8">
                ...
                <div class="comment-list">
                 <div class="single-comment justify-content-between d-flex mb-30">
                  <div class="user justify-content-between d-flex">
                   <div class="thumb text-center">
                    <img alt="" src="assets/imgs/blog/author-2.png"/>
                 ...
                 <div class="single-comment justify-content-between d-flex mb-30 ml-30">
                  <div class="user justify-content-between d-flex">
                   <div class="thumb text-center">
                    <img alt="" src="assets/imgs/blog/author-3.png"/>
                    <a class="font-heading text-brand" href="#">
                     Brenna
                    </a>
                   </div>
                 ...
                 <div class="single-comment justify-content-between d-flex">
                  <div class="user justify-content-between d-flex">
                   <div class="thumb text-center">
                    <img alt="" src="assets/imgs/blog/author-4.png"/>
                    <a class="font-heading text-brand" href="#">
                     Gemma
                    </a>
                   </div>
               ...
               <div class="col-lg-4">
                ...
                <div class="progress">
                 ...
                 <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="65" class="progress-bar" role="progressbar" style="width: 65%">
                  65%
                 </div>
                </div>
                <div class="progress mb-30">
                 ...
                 <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="85" class="progress-bar" role="progressbar" style="width: 85%">
                  85%
                 </div>
                </div>
             ...
             <div class="comment-form">
              ...
              <div class="row">
               <div class="col-lg-8 col-md-12">
                <form action="#" class="form-contact comment_form" id="commentForm">
                 <div class="row">
                  <div class="col-12">
                   <div class="form-group">
                    <textarea class="form-control w-100" cols="30" id="comment" name="comment" placeholder="Write Comment" rows="9"></textarea>
                   </div>
                  </div>
                  <div class="col-sm-6">
                   <div class="form-group">
                 ...
                 <div class="form-group">
                  <button class="button button-contactForm" type="submit">
                   Submit Review
                  </button>
                 </div>
                </form>
              ...
              <div class="product-img-action-wrap">
               <div class="product-img product-img-zoom">
                <a href="/shop-product-right" tabindex="0">
                 <img alt="" class="default-img" src="assets/imgs/shop/product-2-1.jpg"/>
                 <img alt="" class="hover-img" src="assets/imgs/shop/product-2-2.jpg"/>
                </a>
               </div>
               <div class="product-action-1">
                <a aria-label="Quick view" class="action-btn small hover-up" data-bs-target="#quickViewModal" data-bs-toggle="modal">
                 <i class="fi-rs-search">
                 </i>
                </a>
                <a aria-label="Add To Wishlist" class="action-btn small hover-up" href="/shop-wishlist" tabindex="0">
                 <i class="fi-rs-heart">
                 </i>
                </a>
                <a aria-label="Compare" class="action-btn small hover-up" href="/shop-compare" tabindex="0">
                 <i class="fi-rs-shuffle">
                 </i>
                </a>
               </div>
            ...
            <div class="col-lg-3 col-md-4 col-12 col-sm-6">
             <div class="product-cart-wrap hover-up">
              <div class="product-img-action-wrap">
               <div class="product-img product-img-zoom">
                <a href="/shop-product-right" tabindex="0">
                 <img alt="" class="default-img" src="assets/imgs/shop/product-3-1.jpg"/>
                 <img alt="" class="hover-img" src="assets/imgs/shop/product-4-2.jpg"/>
                </a>
               </div>
               <div class="product-action-1">
                <a aria-label="Quick view" class="action-btn small hover-up" data-bs-target="#quickViewModal" data-bs-toggle="modal">
            ...
            <div class="col-lg-3 col-md-4 col-12 col-sm-6">
             <div class="product-cart-wrap hover-up">
              <div class="product-img-action-wrap">
               <div class="product-img product-img-zoom">
                <a href="/shop-product-right" tabindex="0">
                 <img alt="" class="default-img" src="assets/imgs/shop/product-4-1.jpg"/>
                 <img alt="" class="hover-img" src="assets/imgs/shop/product-4-2.jpg"/>
                </a>
               </div>
               <div class="product-action-1">
            ...
            <div class="col-lg-3 col-md-4 col-12 col-sm-6 d-lg-block d-none">
             <div class="product-cart-wrap hover-up mb-0">
              <div class="product-img-action-wrap">
               <div class="product-img product-img-zoom">
                <a href="/shop-product-right" tabindex="0">
                 <img alt="" class="default-img" src="assets/imgs/shop/product-5-1.jpg"/>
                 <img alt="" class="hover-img" src="assets/imgs/shop/product-3-2.jpg"/>
                </a>
               </div>
               <div class="product-action-1">
                <a aria-label="Quick view" class="action-btn small hover-up" data-bs-target="#quickViewModal" data-bs-toggle="modal">
       ...
       <div class="col-xl-3 primary-sidebar sticky-sidebar mt-30">
        ...
        <div class="sidebar-widget price_range range mb-30">
         ...
         <div class="price-filter">
          <div class="price-filter-inner">
           <div class="mb-20" id="slider-range">
           </div>
           <div class="d-flex justify-content-between">
            <div class="caption">
             From:
             <strong class="text-brand" id="slider-range-value1">
             </strong>
            </div>
            <div class="caption">
             To:
             <strong class="text-brand" id="slider-range-value2">
             </strong>
            </div>
           </div>
          </div>
        ...
        <div class="sidebar-widget product-sidebar mb-30 p-30 bg-grey border-radius-10">
         ...
         <div class="single-post clearfix">
          <div class="image">
           <img alt="#" src="assets/imgs/shop/thumbnail-3.jpg"/>
          </div>
         ...
         <div class="single-post clearfix">
          <div class="image">
           <img alt="#" src="assets/imgs/shop/thumbnail-4.jpg"/>
          </div>
          <div class="content pt-10">
           <h6>
            <a href="shop-product-detail.html">
         ...
         <div class="single-post clearfix">
          <div class="image">
           <img alt="#" src="assets/imgs/shop/thumbnail-5.jpg"/>
          </div>
          <div class="content pt-10">
           <h6>
            <a href="shop-product-detail.html">
        ...
        <div class="banner-img wow fadeIn mb-lg-0 animated d-lg-block d-none">
         <img alt="" src="assets/imgs/banner/banner-11.png"/>
     ...
     <div class="row">
      <div class="col-lg-12">
       <div class="position-relative newsletter-inner">
        ...
        <img alt="newsletter" src="assets/imgs/banner/banner-9.png"/>
       </div>
      </div>
     </div>
    </div>
    ...
    <div class="container">
     <div class="row">
      ...
      <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
       <div class="banner-left-icon d-flex align-items-center wow fadeIn animated">
        <div class="banner-icon">
         <img alt="" src="assets/imgs/theme/icons/icon-5.svg"/>
        </div>
        <div class="banner-text">
         <h3 class="icon-box-title">
          Easy returns
      ...
      <div class="col-lg-1-5 col-md-4 col-12 col-sm-6 d-xl-none">
       <div class="banner-left-icon d-flex align-items-center wow fadeIn animated">
        <div class="banner-icon">
         <img alt="" src="assets/imgs/theme/icons/icon-6.svg"/>
        </div>
        <div class="banner-text">
         <h3 class="icon-box-title">
          Safe delivery
     ...
     <div class="row">
      <div class="col">
       <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
        ...
        <ul class="contact-infor">
         ...
         <li>
          <img alt="" src="assets/imgs/theme/icons/icon-email-2.svg"/>
          <strong>
           Email:
          </strong>
          <span>
         ...
         <li>
          <img alt="" src="assets/imgs/theme/icons/icon-clock.svg"/>
          <strong>
           Hours:
          </strong>
          <span>
      ...
      <div class="footer-link-widget widget-install-app col">
       ...
       <div class="download-app">
        <a class="hover-up mb-sm-2 mb-lg-0" href="#">
         <img alt="" class="active" src="assets/imgs/theme/app-store.jpg"/>
        </a>
        <a class="hover-up mb-sm-2" href="#">
         <img alt="" src="assets/imgs/theme/google-play.jpg"/>
        </a>
       </div>
       <p class="mb-20">
        Secured Payment Gateways
       </p>
       <img alt="" class="wow fadeIn animated" src="assets/imgs/theme/payment-method.png"/>
      </div>
     </div>
    </div>
   </section>
    ...
    <div class="row align-items-center">
     ...
     <div class="col-xl-4 col-lg-6 text-center d-none d-xl-block">
      <div class="hotline d-lg-inline-flex mr-30">
       <img alt="hotline" src="assets/imgs/theme/icons/phone-call.svg"/>
       <p>
        1900 - 6666
        <span>
         Working 8:00 - 22:00
  ...
  <div id="preloader-active">
   <div class="preloader d-flex align-items-center justify-content-center">
    <div class="preloader-inner position-relative">
     <div class="text-center">
      <img alt="" src="assets/imgs/theme/loading.gif"/>
     </div>
    </div>
   </div>
  </div>
  ...
  <!-- Template  JS -->
  <script src="./assets/js/main.js?v=6.0">
  </script>
  <script src="./assets/js/shop.js?v=6.0">
  </script>
 </body>
</html>
