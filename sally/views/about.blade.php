   ...
   <div class="page-content pt-50">
     ...
     <div class="row">
      <div class="col-xl-10 col-lg-12 m-auto">
       <section class="row align-items-center mb-50">
        <div class="col-lg-6">
         <img alt="" class="border-radius-15 mb-md-3 mb-lg-0 mb-sm-4" src="assets/imgs/page/about-1.png"/>
        </div>
        <div class="col-lg-6">
         <div class="pl-25">
          <h2 class="mb-30">
          ...
          <div class="carausel-3-columns-cover position-relative">
           ...
           <div class="carausel-3-columns" id="carausel-3-columns">
            <img alt="" src="assets/imgs/page/about-2.png"/>
            <img alt="" src="assets/imgs/page/about-3.png"/>
            <img alt="" src="assets/imgs/page/about-4.png"/>
            <img alt="" src="assets/imgs/page/about-2.png"/>
           </div>
          </div>
         </div>
       ...
       <section class="row align-items-center mb-50">
        <div class="row mb-50 align-items-center">
         <div class="col-lg-7 pr-30">
          <img alt="" class="mb-md-3 mb-lg-0 mb-sm-4" src="assets/imgs/page/about-5.png"/>
         </div>
         <div class="col-lg-5">
          <h4 class="mb-20 text-muted">
           Our performance
          </h4>
    ...
    <div class="container">
     <div class="row">
      <div class="col-xl-10 col-lg-12 m-auto">
       <section class="mb-50">
        <h2 class="title style-3 mb-40 text-center">
         Our Team
        </h2>
        <div class="row">
         <div class="col-lg-4 mb-lg-0 mb-md-5 mb-sm-5">
          <h6 class="mb-5 text-brand">
           Our Team
          </h6>
          <h1 class="mb-30">
         ...
         <div class="col-lg-8">
          <div class="row">
           <div class="col-lg-6 col-md-6">
            <div class="team-card">
             <img alt="" src="assets/imgs/page/about-6.png"/>
             <div class="content text-center">
              ...
              <div class="social-network mt-20">
               <a href="#">
                <img alt="" src="assets/imgs/theme/icons/icon-facebook-brand.svg"/>
               </a>
               <a href="#">
                <img alt="" src="assets/imgs/theme/icons/icon-twitter-brand.svg"/>
               </a>
               <a href="#">
                <img alt="" src="assets/imgs/theme/icons/icon-instagram-brand.svg"/>
               </a>
               <a href="#">
                <img alt="" src="assets/imgs/theme/icons/icon-youtube-brand.svg"/>
               </a>
              </div>
             </div>
            </div>
           ...
           <div class="col-lg-6 col-md-6">
            <div class="team-card">
             <img alt="" src="assets/imgs/page/about-8.png"/>
             <div class="content text-center">
              <h4 class="mb-5">
               Dilan Specter
              </h4>
