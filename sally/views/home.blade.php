                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <h3 class="title-detail"><a class='text-heading' href='/shop-product-right'>Seeds of
                            ...
                            <div class="header-action-2">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href='/shop-product-right'><img alt="Nest"
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                        <ul>
                                            <li><a href='/page-account'><i class="fi fi-rs-user mr-10"></i>My
                                                    Account</a></li>
                                            <li><a href='/page-account'><i
                                                        class="fi fi-rs-location-alt mr-10"></i>Order Tracking</a></li>
                                            <li><a href='/page-account'><i class="fi fi-rs-label mr-10"></i>My
                                                    Voucher</a></li>
                                            <li><a href='/shop-wishlist'><i class="fi fi-rs-heart mr-10"></i>My
                                                    Wishlist</a></li>
                                            <li><a href='/page-account'><i
                                                        class="fi fi-rs-settings-sliders mr-10"></i>Setting</a></li>
                                            <li><a href='/page-login'><i class="fi fi-rs-sign-out mr-10"></i>Sign
                                                    out</a></li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <nav>
                                <ul>
                                    <li class="hot-deals"><img src="assets/imgs/theme/icons/icon-hot.svg"
                                            alt="hot deals" /><a href='/shop-grid-right'>Deals</a></li>
                                    <li>
            ...
            <div class="row flex-row-reverse">
                <div class="col-lg-4-5">
                    ...
                    <section class="product-tabs section-padding position-relative">
                        ...
                        <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap mb-30">
                                            <div class="product-img-action-wrap">
                                                ...
                                                <div class="product-action-1">
                                                    <a aria-label='Add To Wishlist' class='action-btn'
                                                        href='/shop-wishlist'><i class="fi-rs-heart"></i></a>
                                                    <a aria-label='Compare' class='action-btn'
                                                        href='/shop-compare'><i class="fi-rs-shuffle"></i></a>
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Seeds of Change Organic Quinoe</a>
                                                </h2>
                                                ...
                                                <div>
                                                    <span class="font-small text-muted">By <a
                                                            href='/vendor-details-1'>NestFood</a></span>
                                                </div>
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap mb-30">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>All Natural Italian-Style Chicken
                                                        Meatballs</a></h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                ...
                                                <div>
                                                    <span class="font-small text-muted">By <a
                                                            href='/vendor-details-1'>Stouffer</a></span>
                                                </div>
                                                <div class="product-card-bottom">
                                                    <div class="product-price">
                                                        <span>$52.85</span>
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap mb-30">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Angie’s Boomchickapop Sweet &
                                                        Salty</a></h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                ...
                                                <div>
                                                    <span class="font-small text-muted">By <a
                                                            href='/vendor-details-1'>StarKist</a></span>
                                                </div>
                                                <div class="product-card-bottom">
                                                    <div class="product-price">
                                                        <span>$48.85</span>
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap mb-30">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Foster Farms Takeout Crispy
                                                        Classic</a></h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                        <div class="product-rating" style="width: 90%"></div>
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href='/shop-product-right'>
                                                        <img class="default-img"
                                                            src="assets/imgs/shop/product-6-1.jpg" alt="" />
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Chobani Complete Vanilla Greek</a>
                                                </h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                        <div class="product-rating" style="width: 90%"></div>
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Canada Dry Ginger Ale – 2 L
                                                        Bottle</a></h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                        <div class="product-rating" style="width: 90%"></div>
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Encore Seafoods Stuffed Alaskan</a>
                                                </h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                        <div class="product-rating" style="width: 90%"></div>
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Gorton’s Beer Battered Fish
                                                        Fillets</a></h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                        <div class="product-rating" style="width: 90%"></div>
                                                ...
                                                <div>
                                                    <span class="font-small text-muted">By <a
                                                            href='/vendor-details-1'>Old El Paso</a></span>
                                                </div>
                                                <div class="product-card-bottom">
                                                    <div class="product-price">
                                                        <span>$23.85</span>
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6 d-none d-xl-block">
                                        <div class="product-cart-wrap">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Haagen-Dazs Caramel Cone Ice
                                                        Cream</a></h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                ...
                                                <div>
                                                    <span class="font-small text-muted">By <a
                                                            href='/vendor-details-1'>Tyson</a></span>
                                                </div>
                                                <div class="product-card-bottom">
                                                    <div class="product-price">
                                                        <span>$22.85</span>
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap mb-30">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Seeds of Change Organic Quinoa,
                                                        Brown, & Red Rice</a></h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                        <div class="product-rating" style="width: 90%"></div>
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap mb-30">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Angie’s Boomchickapop Sweet & Salty
                                                        Kettle Corn</a></h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                        <div class="product-rating" style="width: 85%"></div>
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap mb-30">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Foster Farms Takeout Crispy Classic
                                                        Buffalo Wings</a></h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                        <div class="product-rating" style="width: 90%"></div>
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap mb-30">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Blue Diamond Almonds Lightly Salted
                                                        Vegetables</a></h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                        <div class="product-rating" style="width: 90%"></div>
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Chobani Complete Vanilla Greek
                                                        Yogurt</a></h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                        <div class="product-rating" style="width: 90%"></div>
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Canada Dry Ginger Ale – 2 L Bottle -
                                                        200ml - 400g</a></h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                        <div class="product-rating" style="width: 90%"></div>
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Encore Seafoods Stuffed Alaskan
                                                        Salmon</a></h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                        <div class="product-rating" style="width: 90%"></div>
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Gorton’s Beer Battered Fish Fillets
                                    ...
                                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6 d-none d-xl-block">
                                        <div class="product-cart-wrap">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href='/shop-product-right'>Haagen-Dazs Caramel Cone Ice Cream
                                                        Ketchup</a></h2>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                        <div class="product-rating" style="width: 50%"></div>
                                                ...
                                                <div class="product-img product-img-zoom">
                                                    <a href='/shop-product-right'>
                                                        <img class="default-img"
                                                            src="assets/imgs/shop/product-6-1.jpg" alt="" />
                                                        <img class="hover-img"
                                                            src="assets/imgs/shop/product-6-2.jpg" alt="" />
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                                    <a aria-label='Add To Wishlist' class='action-btn'
                            ...
                            <!--En tab six-->
                            <div class="tab-pane fade" id="tab-seven" role="tabpanel"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="product-cart-wrap style-2">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="deals-content">
                                            <h2><a href='/shop-product-right'>Perdue Simply Smart Organics Gluten</a>
                                            </h2>
                                            <div class="product-rate-cover">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width: 90%"></div>
                                ...
                                <div class="product-cart-wrap style-2">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="deals-content">
                                            ...
                                            <div>
                                                <span class="font-small text-muted">By <a
                                                        href='/vendor-details-1'>Progresso</a></span>
                                            </div>
                                            <div class="product-card-bottom">
                                                <div class="product-price">
                                                    <span>$12.85</span>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 d-none d-xl-block">
                                <div class="product-cart-wrap style-2">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="deals-content">
                                            <h2><a href='/shop-product-right'>Simply Lemonade with Raspberry Juice</a>
                                            </h2>
                                            <div class="product-rate-cover">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width: 80%"></div>
                                            ...
                                            <div>
                                                <span class="font-small text-muted">By <a
                                                        href='/vendor-details-1'>Yoplait</a></span>
                                            </div>
                                            <div class="product-card-bottom">
                                                <div class="product-price">
                                                    <span>$15.85</span>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="banner-img">
                                    ...
                                    <div class="banner-text">
                                        ...
                                        <a class='btn btn-xs' href='/shop-grid-right'>Shop Now <i
                ...
                <div class="col-lg-1-5 primary-sidebar sticky-sidebar pt-30">
                    <div class="sidebar-widget widget-category-2 mb-30">
                        ...
                        <ul>
                            <li>
                                <a href='/shop-grid-right'> <img src="assets/imgs/theme/icons/category-1.svg"
                                        alt="" />Milks & Dairies</a><span class="count">30</span>
                            </li>
                            <li>
                                <a href='/shop-grid-right'> <img src="assets/imgs/theme/icons/category-2.svg"
                                        alt="" />Clothing</a><span class="count">35</span>
                            </li>
                            <li>
                                <a href='/shop-grid-right'> <img src="assets/imgs/theme/icons/category-3.svg"
                                        alt="" />Pet Foods </a><span class="count">42</span>
                            </li>
                            <li>
                                <a href='/shop-grid-right'> <img src="assets/imgs/theme/icons/category-4.svg"
                                        alt="" />Baking material</a><span class="count">68</span>
                            </li>
                            <li>
                                <a href='/shop-grid-right'> <img src="assets/imgs/theme/icons/category-5.svg"
                    ...
                    <div class="sidebar-widget price_range range mb-30">
                        ...
                        <a class='btn btn-sm btn-default' href='/shop-grid-right'><i
                ...
                <div class="carausel-8-columns-cover position-relative">
                    <div class="carausel-8-columns" id="carausel-8-columns">
                        <div class="card-1">
                            ...
                            <h6>
                                <a href='/shop-grid-right'>Milks and <br />Dairies</a>
                            </h6>
                        </div>
                        <div class="card-1">
                            <figure class="img-hover-scale overflow-hidden">
                            ...
                            <h6>
                                <a href='/shop-grid-right'>Wines & <br />
                                    Alcohol</a>
                            </h6>
                        </div>
                        <div class="card-1">
                            ...
                            <h6>
                                <a href='/shop-grid-right'>Clothing & <br />Beauty</a>
                            </h6>
                        </div>
                        <div class="card-1">
                            <figure class="img-hover-scale overflow-hidden">
                            ...
                            <h6>
                                <a href='/shop-grid-right'>Pet Foods <br />& Toy</a>
                            </h6>
                        </div>
                        <div class="card-1">
                            <figure class="img-hover-scale overflow-hidden">
                            ...
                            <h6>
                                <a href='/shop-grid-right'>Packaged <br />fast food</a>
                            </h6>
                        </div>
                        <div class="card-1">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href='/shop-grid-right'><img src="assets/imgs/theme/icons/category-6.svg"
                                        alt="" /></a>
                            </figure>
                            <h6>
                                <a href='/shop-grid-right'>Baking <br />material</a>
                            </h6>
                        </div>
                        <div class="card-1">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href='/shop-grid-right'><img src="assets/imgs/theme/icons/category-7.svg"
                                        alt="" /></a>
                            </figure>
                            <h6>
                                <a href='/shop-grid-right'>Vegetables <br />& tubers</a>
                            </h6>
                        </div>
                        <div class="card-1">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href='/shop-grid-right'><img src="assets/imgs/theme/icons/category-8.svg"
                                        alt="" /></a>
                            </figure>
                            <h6>
                                <a href='/shop-grid-right'>Fresh <br />Seafood</a>
                            </h6>
                        </div>
                        <div class="card-1">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href='/shop-grid-right'><img src="assets/imgs/theme/icons/category-9.svg"
                                        alt="" /></a>
                            </figure>
                            <h6>
                                <a href='/shop-grid-right'>Noodles <br />Rice</a>
                            </h6>
                        </div>
                        <div class="card-1">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href='/shop-grid-right'><img src="assets/imgs/theme/icons/category-10.svg"
                                        alt="" /></a>
                            </figure>
                            <h6><a href='/shop-grid-right'>Fastfood</a></h6>
                        </div>
                        <div class="card-1">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href='/shop-grid-right'><img src="assets/imgs/theme/icons/category-11.svg"
                                        alt="" /></a>
                            </figure>
                            <h6><a href='/shop-grid-right'>Ice cream</a></h6>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href='/shop-product-right'><img src="assets/imgs/shop/thumbnail-1.jpg"
                                            alt="" /></a>
                                </figure>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href='/shop-product-right'><img src="assets/imgs/shop/thumbnail-2.jpg"
                                            alt="" /></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href='/shop-product-right'><img src="assets/imgs/shop/thumbnail-3.jpg"
                                            alt="" /></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-md-0">
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href='/shop-product-right'><img src="assets/imgs/shop/thumbnail-4.jpg"
                                            alt="" /></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href='/shop-product-right'><img src="assets/imgs/shop/thumbnail-5.jpg"
                                            alt="" /></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                                        <a href='/shop-product-right'>Seeds of Change Organic Quinoa, Brown, & Red
                                            Rice</a>
                                    </h6>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href='/shop-product-right'><img src="assets/imgs/shop/thumbnail-6.jpg"
                                            alt="" /></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                                        <a href='/shop-product-right'>Naturally Flavored Cinnamon Vanilla Light Roast
                                            Coffee</a>
                                    </h6>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-lg-block">
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href='/shop-product-right'><img src="assets/imgs/shop/thumbnail-7.jpg"
                                            alt="" /></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href='/shop-product-right'><img src="assets/imgs/shop/thumbnail-8.jpg"
                                            alt="" /></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href='/shop-product-right'><img src="assets/imgs/shop/thumbnail-9.jpg"
                                            alt="" /></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-xl-block">
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href='/shop-product-right'><img src="assets/imgs/shop/thumbnail-10.jpg"
                                            alt="" /></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                                        <a href='/shop-product-right'>Foster Farms Takeout Crispy Classic Buffalo
                                            Wings</a>
                                    </h6>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href='/shop-product-right'><img src="assets/imgs/shop/thumbnail-11.jpg"
                                            alt="" /></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                                        <a href='/shop-product-right'>Angie’s Boomchickapop Sweet & Salty Kettle
                                            Corn</a>
                                    </h6>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href='/shop-product-right'><img src="assets/imgs/shop/thumbnail-12.jpg"
                                            alt="" /></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
                            <div class="logo mb-30">
                                <a class='mb-15' href='/'><img src="assets/imgs/theme/logo.svg"
                                        alt="logo" /></a>
